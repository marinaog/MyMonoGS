...
if both:
    # Paths
    ply_path_raw = pathresults + f"_raw/point_cloud/final/point_cloud.ply"
    config_path_raw = f"configs/rgbd/rawslam/{scene}_raw.yaml"
    est_pose_path_raw = pathresults + f"_raw/plot/trj_final.json"
    save_dir_raw = f"BOTHrawslam_{scene}_raw_{runnum}"


    ply_path_srgb = pathresults + f"_srgb/point_cloud/final/point_cloud.ply"
    config_path_srgb = f"configs/rgbd/rawslam/{scene}.yaml"
    est_pose_path_srgb = pathresults + f"_srgb/plot/trj_final.json"
